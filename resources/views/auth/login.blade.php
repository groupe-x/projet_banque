    ...
    <div class="session">
      ...
      <style type="text/css">
          ...
          <form method="POST" class="log-in" action="{{ route('login.login') }}">
            ...
            <div class="floating-label">
              <input placeholder="Email" type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" name="password" required autocomplete="current-password">
      ...
      <rect class="st0" width="100" height="100"/>
            ...
            @error('password')
                                ...
                                @enderror
            <div class="floating-label">
              <input placeholder="Password" type="password" name="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required >
